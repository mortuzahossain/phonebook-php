		...
		<div class="row">
			<form action="" method="post" class="col-md-12"  enctype="multipart/form-data">
				<div class="sigle-input col-md-12">
					...
					<input class="col-md-8" type="text" name="name" placeholder="Md Mortuza Hossain">
				</div>
				<div class="sigle-input col-md-12">
					<label class="col-md-3">Phone No: *</label>
					<input class="col-md-8" type="text" name="phone" placeholder="01719200957">
				</div>
				<div class="sigle-input col-md-12">
				...
				<div class="sigle-input col-md-12">
					...
					<input class="col-md-8" type="text" name="address" placeholder="Dhaka , Bangladesh">
				</div>
				<div class="sigle-input col-md-12">
